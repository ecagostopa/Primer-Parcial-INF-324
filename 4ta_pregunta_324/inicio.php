...
<body >
			...
			<div class="carousel-inner">
				<div class="carousel-item active" style="height: 80vh">
					...
					<div class="carousel-caption d-none d-md-block">
						<h5 class="display-4 mb-4 font-weight-bold">DOCENTE</h5>
	...
	<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color: <?php 
...
?>;">
			...
			<div class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						<a class="dropdown-item" href="http://www.informatica.edu.bo/">Informacion</a>
						<a class="dropdown-item" href="https://ssainformatica.umsa.bo/">Kardex</a>
						<a class="dropdown-item" href="http://instituto.informatica.edu.bo/">Investigaciones</a>
					</div>
				</li>
				<a class="nav-item nav-link text-justify ml-3 hover-primary" href="">Salir</a>
			</div>
			<form action="file.php" method="POST" class="d-flex">
				<input type="text" name="color" class="form-control me-2" placeholder="Color">
				<input type="submit" name="change"  class="btn btn-outline-danger">
			</form>
	...
	<div class="">
		<div class="jumbotron text-light rounded-0" style="background-color: <?php 
	if (isset($_SESSION['color'])) {
		echo $_SESSION['color'];
	}
	else{
...
?>;">
			...
			<p class="lead">Registro de estudiantes inscritos en la materia con su respectiva calificacion.</p>
			...
			<p class="lead">Registro de la media de notas de cada departamento.</p>

			<div class="d-flex justify-content-between align-items-center flex-wrap">
				<?php
					include ("modelo/conexion.php");
					include ("media_notas.php");
				?>
			</div>
		</div>
	</div>
